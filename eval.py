...
def eval_dvc(submission, references, tious=[0.3, 0.5, 0.7, 0.9], distances=[1, 3, 5, 10, 30, 60],
    ...
    avg_eval_score = {key: np.array(value).mean() for key, value in score.items() if
                      key not in ["Recall", "Precision", "F1"]}
